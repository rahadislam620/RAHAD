...
\033[1;37m------------------------------------------------
\033[1;37m Owner   :                Md Rahad Islam 
\033[1;37m Facebook:            R　A　H　A　D　ツ
\033[1;37m Github  :             rahadislam620/RAHAD
...
def cutter():
    ...
    print(" ")
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +rahad)
    os.system('sort -r '+rrr+' | uniq > '+sarfraz)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + rrr )
    print("New File Saved:" + rahad )
    print(47*'-')
    input(f"{S} Press Enter To Back RRR Menu ")
    SSB(allkey)       
